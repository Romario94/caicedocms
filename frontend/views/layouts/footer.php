...
<!--          <div class="contact-info-box address clearfix">
          ...
          <ul class="social-link">
            <li class="twitter animated bounceIn wow delay-02s"><a href="https://twitter.com/Romariolex" target="_blank"><i class="fa-twitter"></i></a></li>
            <li class="facebook animated bounceIn wow delay-03s"><a href="https://www.facebook.com/alexander.caicedo.7" target="_blank"><i class="fa-facebook"></i></a></li>
<!--            <li class="pinterest animated bounceIn wow delay-04s"><a href="javascript:void(0)"><i class="fa-pinterest"></i></a></li>-->
            <li class="gplus animated bounceIn wow delay-05s"><a href="https://plus.google.com/u/0/+AlexanderCaicedo20030" target="_blank"><i class="fa-google-plus"></i></a></li>
